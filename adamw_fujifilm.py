...
def crop_images(input_image, gt_image):
    ...
    # crop input image
    input_patch = input_image[:, yy:yy + ps, 
                              xx:xx + ps, :]
...
model.load_weights('weights.1935-5761.6689.hdf5')
...
input_dataset = tf.data.Dataset.from_generator(
    ...
    (tf.float32, tf.uint16),
    (tf.TensorShape([None, None, None, None]), tf.TensorShape([None, None, None, None])))
