...
def crop_images(input_images, gt_images):
...
class DataGenerator(Sequence):
    def __init__(self, input_fns, gt_fns, batch_size, validation=False):
    ...
    def __getitem__(self, i):
        ...
        if TESTING:
            ...
            batch = crop_images(input_images, gt_images)
        else:
            input_images, gt_images = crop_images(input_images, gt_images)
...
class TimerCallback(Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        time_file = open('train_time-' + today + '.txt', 'a')
...
checkpoint = ModelCheckpoint('/content/drive/My Drive/FYP/sony/weights_with_history/{epoch:04d}-{val_loss:.4f}.hdf5', 
                             monitor='val_loss', 
                             verbose=0,
                             save_best_only=True,
...
if TESTING:
    ...
    history = model.fit(DataGenerator(input_fns, input_gt_fns, batch_size),
                        validation_data=DataGenerator(validation_fns, validation_gt_fns, batch_size, validation=True),
                        validation_freq=1,
                        epochs=4000,
                        # use_multiprocessing=True,
                        shuffle=True,
